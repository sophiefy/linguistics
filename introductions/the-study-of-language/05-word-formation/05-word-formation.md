...
可以发现，即便我们不知道Spangler这个人，但理解spangler及spanglering、spanglered、spanglerish等**新词（neologism）**时并不困难。这暗示我们语言的构词过程一定是有迹可循的。
...
此外，有时词性变化过程中还会伴随含义的变化。例如doctor作为动词时是"伪造"，runaround作为名词时是"借口"。
